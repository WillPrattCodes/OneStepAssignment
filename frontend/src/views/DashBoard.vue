<template>
  <div class="flex bg-gray-100">
    ...
    <div
      class="w-1/3 h-screen p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200"
    >
      ...
      <div v-if="showPreferences" class="p-4 mb-6 bg-white border rounded shadow-lg">
        ...
        <button
          ...
          :class="[
            'w-full p-2 mt-2 rounded',
            preferences.sortOrder === 'asc' ? 'bg-blue-600 text-white' : 'bg-gray-200',
          ]"
        >
          Ascending
        </button>
        <button
          ...
          :class="[
            'w-full p-2 mt-2 rounded',
            preferences.sortOrder === 'desc' ? 'bg-blue-600 text-white' : 'bg-gray-200',
          ]"
        >
          Descending
        </button>
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-gray-600">
                <strong>Location:</strong> Lat: {{ device.latest_device_point?.lat.toFixed(3) }},
                Lng: {{ device.latest_device_point?.lng.toFixed(3) }}
              </p>
              <p class="text-sm text-gray-600">
